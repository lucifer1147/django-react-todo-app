...
function ListWrapper(props) {
    ...
    return (
        <div id="list-wrapper"
            ...
            <div className="sticky h-22 px-16 py-10 w-full top-[0px] bg-indigo-100 mb-5 dark:bg-indigo-950 rounded-xl bg-opacity-80 dark:bg-opacity-70 backdrop-blur-sm">
            ...
            <div className="px-16 py-16 bg-indigo-100 dark:bg-indigo-950 shadow-black shadow-2xl rounded-xl overflow-x-auto dark:text-white bg-opacity-80 dark:bg-opacity-70 backdrop-blur-sm h-full">
                <ul className="flex flex-col justify-center gap-y-3">
                    {(props.TodoList.length > 0 ? props.TodoList.toReversed().map((obj) => {
                        ...
                        <div className="px-12 py-5 w-full rounded-md bg-white shadow-sm dark:bg-gray-900 bg-opacity-70 dark:bg-opacity-70">
